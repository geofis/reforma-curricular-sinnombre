...
* **E1. Curso organizado por prácticas integradoras (taller + defensa)**  
  La asignatura se estructura en **4 prácticas de unidad** y **1 proyecto de investigación/desarrollo**.  
...
evaluacion <- data.frame(
  ...
  Tecnicas = c(
    ...
    "Proyecto de investigación/desarrollo: manuscrito reproducible (con datos de campo)",
    "Proyecto de investigación/desarrollo: presentación y defensa",
